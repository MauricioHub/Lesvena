...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private String initialDate = "2017-01-01 15:35:26";
    ...
    private void attemptLogin() {
        final LesvenaUtil utiLes = new LesvenaUtil(this);
        DatasetAdmin admBase = new DatasetAdmin(this);
        ...
        try{
            ...
            MainActivity.data.setUsername(username);
            MainActivity.data.setPassword(password);
                            ...
                            public void onJSONResponse(boolean success, JSONObject response) {
                                if(success){
                                    try {
                                        ...
                                        nuevoUsuario.setTokenize(response.getString("hash"));
                                        MainActivity.data.setUsuario(nuevoUsuario);
                                        MainActivity.banderita = false;
                                        cancel2 = true;
                                        sincronizeDataset(initialDate);

                                    } catch (JSONException e) {
                                        e.printStackTrace();
                                    }
                                } else {
                                    Toast.makeText(contexto,"USUARIO NO REGISTRADO!!",
    ...
    public void sincronizeDataset(String todayCalendar){
        ...
        //int valorEst, valorClas = 0;
        String nuevoStr = "";
        MainActivity.dateString = todayCalendar;

        try {
            syncList = loadSincronizeBegin();
                        ...
                        public void onJSONResponse(boolean success, JSONObject response) {
                            ...
                            try {
                                if(success){
                                    ...
                                    estadoList = utiLes.loadListEstadoTmp(obJSONEstado);
                                    clasifList = utiLes.loadListClasificacionTmp(obJSONClasificacion);
                                    ...
                                    admBase.registerSincronizacionTable();
                                    admBase.registerUsuario(nuevoUsuario);
